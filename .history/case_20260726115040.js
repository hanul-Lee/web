...
const caseStudies = {
  ...
  intranet: {
    ...
    iteration:{initial:'PC 화면을 축소한 목록·입력 중심 예약 구조', feedback:'사용자는 상세 목록보다 예약 가능한 장소와 시간을 한 화면에서 먼저 확인하고 싶어 했습니다.', final:'위치·날짜·시간과 예약 행동을 한 화면에 연결한 구조', initialImage:'assets/cases/intranet-4.jpg', finalImage:'assets/cases/intranet-4.jpg', initialCrop:'left', finalCrop:'right'},
